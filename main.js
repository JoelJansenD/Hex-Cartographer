...
const SVG_SYMBOL_CONFIG = {
    ...
    'town':        { size: 0.60,  align: 'center', marginX: 0, marginY: -3 },
...
const TRANSLATIONS = {
    ...
    zh: {
        ...
        'settings.exportWidth': '默认导出宽度 (px)',
        ...
        'guide.hexcolor.palette': '右键点击调色板位置 = 保存颜色。',
        'guide.symbols': '符号',
    ...
    ru: {
        ...
        'settings.exportWidth': 'Стандартная ширина экспорта (px)',
        ...
        'guide.hexcolor.palette': 'Правый клик по месту в палитре = Сохранить цвет.',
    ...
    ja: {
        ...
        'settings.exportWidth': 'デフォルトのエクスポート幅 (px)',
        ...
        'guide.hexcolor.palette': 'パレット枠を右クリック = 色を保存。',
        'guide.symbols': 'シンボル',
    ...
    fr: {
        ...
        'settings.exportWidth': 'Largeur d\'export par défaut (px)',
        ...
        'guide.hexcolor.palette': 'Clic droit sur un emplacement de palette = Enregistrer la couleur.',
    ...
    pt: {
        ...
        'settings.exportWidth': 'Largura padrão de exportação (px)',
        ...
        'guide.hexcolor.palette': 'Clique direito no espaço da paleta = Salvar cor.',
    ...
    ko: {
        ...
        'settings.exportWidth': '기본 내보내기 너비 (px)',
        ...
        'guide.hexcolor.palette': '팔레트 자리 우클릭 = 색상 저장.',
        'guide.symbols': '기호',
    ...
    es: {
        ...
        'settings.exportWidth': 'Ancho de exportación predeterminado (px)',
        ...
        'guide.hexcolor.palette': 'Clic derecho en lugar de paleta = Guardar color.',
        'guide.symbols': 'Símbolos',
    ...
    pl: {
        ...
        'settings.exportWidth': 'Domyślna szerokość eksportu (px)',
        ...
        'guide.hexcolor.palette': 'Prawy przycisk na miejsce palety = Zapisz kolor.',
        'guide.symbols': 'Symbole',
    ...
    it: {
        ...
        'settings.exportWidth': 'Larghezza di esportazione predefinita (px)',
        ...
        'guide.hexcolor.palette': 'Clic destro su posto tavolozza = Salva colore.',
