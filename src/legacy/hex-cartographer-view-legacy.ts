...
import {
    ...
    DEFAULT_BORDER_HIGHLIGHT_WIDTH,
    DEFAULT_GRID_SIZE,
...
export class HexCartographerViewLegacy extends ItemView {
    ...
    private lastHex: any;
    private lastErasedHex: any;
    private isReloading: boolean;
    private draggedText: any;
    private startHex: any;
    private borderSettings: { dashes: number; activeRegionId: any; pickedHex: any; visible: boolean; };
    private borderHighlightWidth: number;
    private borderPickMode: boolean;
    private riverSettings: { width: number; activeRiverId: any; editMode: boolean; insertAfter: number | null; };
    private roadSettings: { width: number; activeRoadId: any; editMode: boolean; insertAfter: number | null; };
    private pathDashes: number;
    private pathPickMode: boolean;
    private pathPickPending: any;
    private lastToolGroup: string | null;
    private pathEndInset: number;
    private riverDragIndex: any;
    private roadDragIndex: any;
    private lastWaypointClick: any;
    private pendingHistory: boolean;
    private masterColor: string;
    private hexColorColor: string | undefined;
    private colorPalette: string[];
    private colorPalette2: string[];
    private activeColorSlot: number;
    private isTouchDevice: boolean;
    private colorPickMode: boolean;
    private editMode: boolean;
    private hexOrientation: boolean;
    private drawMode: string;
    private currentToolGroup: string | null = null;
    private patternData: any;
    private patternPickMode: boolean;
    private patternSourceHex: any;
    private svgSymbols: {};
    private svgSymbolsLoaded: boolean;
    private svgLoadPromise: Promise<void>;
    private svgSymbolConfig: { question: { size: number; align: string; marginX: number; marginY: number; }; exclamation: { size: number; align: string; marginX: number; marginY: number; }; cross: { size: number; align: string; marginX: number; marginY: number; }; dot: { size: number; align: string; marginX: number; marginY: number; }; shield: { size: number; align: string; marginX: number; marginY: number; }; pirateskull: { size: number; align: string; marginX: number; marginY: number; }; grass: { size: number; align: string; marginX: number; marginY: number; }; swamp: { size: number; align: string; marginX: number; marginY: number; }; bush: { size: number; align: string; marginX: number; marginY: number; }; tree: { size: number; align: string; marginX: number; marginY: number; }; pine: { size: number; align: string; marginX: number; marginY: number; }; palm: { size: number; align: string; marginX: number; marginY: number; }; hill: { size: number; align: string; marginX: number; marginY: number; }; mountain: { size: number; align: string; marginX: number; marginY: number; }; tent: { size: number; align: string; marginX: number; marginY: number; }; house: { size: number; align: string; marginX: number; marginY: number; }; village: { size: number; align: string; marginX: number; marginY: number; }; town: { size: number; align: string; marginX: number; marginY: number; }; castle: { size: number; align: string; marginX: number; marginY: number; }; harbor: { size: number; align: string; marginX: number; marginY: number; }; monastery: { size: number; align: string; marginX: number; marginY: number; }; tower: { size: number; align: string; marginX: number; marginY: number; }; ruins: { size: number; align: string; marginX: number; marginY: number; }; cave: { size: number; align: string; marginX: number; marginY: number; }; oasis: { size: number; align: string; marginX: number; marginY: number; }; };
    private lastUsedTextSize: number;
    private lastUsedTextColor: string;
    private lastUsedTextOutline: boolean;
    private lastUsedTextBold: boolean;
    private lastUsedTextShadow: boolean;
    private lastUsedTextShadowDistance: number;
    private lastUsedTextShadowOpatown: number;
    private toolConfigs: {};
    private _savedToolGroup: any;
    private _savedDrawMode: any;
    private masterColorInput: any;
    private masterColorBtn: any;
    private canvas: any;
    private ctx: any;
    ...
    private editModeBtn: any;
    private editContent: any;
    private colorEyedropperBtn: any;
    private hexOrientationBtn: any;
    private patternPickerBtn: any;
    private paletteOuter: any;
    private riverBtn: any;
    private roadBtn: any;
    private pathPickerBtn: any;
    private borderPickerBtn: any;
    private riverWidthInput: any;
    private roadWidthInput: any;
    private pathDashesInput: any;
    private borderBtn: any;
    private borderVisBtn: any;
    private borderDashesInput: any;
    private _rightClickLast?: any;
    private isRightMouseErasing?: boolean;
    private rightEraseLastHex: string | null = null;
    ...
    private overlapMap?: {};
    private _initialResizeDone: any;
    ...
    initToolConfigs() {
        return buildToolConfigs(this.toolConfigs, localizeString);
    }
    ...
    updateToolConfigsWithAvailableSVGs() {
        SYMBOL_TOOL_GROUP_IDS.forEach(groupId => {
