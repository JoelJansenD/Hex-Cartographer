...
import CreateAndEditBorderListener from "./event-listeners/create-and-edit-border-listener";
...
import PathCreateAndEditListener from "./event-listeners/path-create-and-edit-listener";
...
import BorderSelectListener from "./event-listeners/border-select-listener";
...
export default class HexCartographerContent {
    ...
    private registerEventListeners() {
        ...
        const unregisterFunctions = registerListeners(this.canvas, [
            ...
            new CreateAndEditBorderListener(context),
            ...
            new PathCreateAndEditListener(context),
