...
export const PATH_OVERLAP_SPACING = 1.5; // Edge-to-edge spacing factor: 1.0 = touching, 1.5 = small gap, 2.0 = noticeable gap
...
export const MIN_ZOOM = 0.01; // Minimum zoom (1% of a hex)
export const MAX_ZOOM = 4; // Maximum zoom (value x 100% of a hex. 4 = 400%)
...
// === Symbol Configuration (Size/Position per Symbol) ===
